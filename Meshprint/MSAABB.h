...
/**
* Axis Aligned Bounding Box (MSAABB), usually calculate some rough but fast collision detection.
*/
class  MSAABB
{
...
public:
	...
	MSAABB(const Vec3f& min, const Vec3f& max);
	...
	*/
	bool intersects(const MSAABB& aabb) const;
	...
	*/
	...
	/**
	* check the MSAABB object is empty(reset).
	*/
	bool isEmpty() const;
